 ...
 * Generated at: 2018-07-07 18:25:17 UTC
...
public final class ThankYou_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("jar:file:/Users/Leela/Desktop/My%20Computer/Workspaces/GIT%20Workspaces/ServletJSP/src/main/webapp/WEB-INF/lib/jstl-1.2.jar!/META-INF/fmt.tld", Long.valueOf(1153365282000L));
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\tvar jsonResponse = JSON.parse(this.responseText);\n");
      out.write("\t\t\t\tdocument.getElementById(\"status\").innerHTML = jsonResponse.status;\n");
      out.write("\t\t\t\tdocument.getElementById(\"time\").innerHTML = jsonResponse.time;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t}\n");
      ...
      out.write("</p>\n");
      out.write("\t\n");
      out.write("\t<p>Your Order Status : <span id=\"status\">");
      ...
      out.write("</span></p>\n");
      out.write("\t<p>Last Updated : <span id=\"time\">");
      ...
      out.write("</span></p>\n");
      out.write("\t<input type=\"button\" value=\"refresh status\" onclick=\"updateStatus()\"/>\n");
      out.write("\t\n");
      out.write("\t");
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /ThankYou.jsp(31,1) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /ThankYou.jsp(31,1) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmt_005fformatNumber_005f0.setType("currency");
    // /ThankYou.jsp(31,1) name = currencyCode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmt_005fformatNumber_005f0.setCurrencyCode((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${currencyCode}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
